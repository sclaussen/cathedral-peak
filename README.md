...
- I would either (a) go really light next time around wrt the pack   (e.g. less food & gear) or (b) take a full framed pack and leave it   at the base.
- I had a larger BD climbing pack that contained a plastic internal   frame that dug into my back and made the hike out very   uncomfortable.
- I would take a smaller rack - I had a doubles up through #3 and a   single #4 - I would likely drop the #4 and consider singles in the   larger BD sizes.
- The route eats up nuts and many sections can be run out relatively   safely.
